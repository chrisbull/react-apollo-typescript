...
const ProtectedRoute = ({ component: Component, token, ...rest }: any) => {
    ...
    return (
      <nav className='pa3 pa4-ns'>
        ...
        {this.state.token ? (
          ...
          <Link to='/login' className='f6 link dim br1 ba ph3 pv2 fr mb2 dib black'>
            Login
          </Link>
        )}
        {this.props.data && this.props.data.me && this.props.data.me.email && this.state.token && (
    ...
    return (
      <div className='fl w-100 pl4 pr4'>
        <Switch>
          ...
          <Route path='/login' render={props => <LoginPage refreshTokenFn={this.refreshTokenFn} />} />
          <Route path='/signup' render={props => <SignupPage refreshTokenFn={this.refreshTokenFn} />} />
