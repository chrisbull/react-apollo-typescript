    ...
    return (
      <div className='pa4 flex justify-center bg-white'>
        <form onSubmit={this.handlePost}>
          ...
          />
          <input
            className={`pa3 bg-black-10 bn ${this.state.content && this.state.title && 'dim pointer'}`}
...
export default graphql(CREATE_DRAFT_MUTATION, { name: 'createDraftMutation' })(withRouter(CreatePageWithMutation))
